...
public class ExecuteQuery01 {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //Verileri alabilmek için:  JDBC kullanarak veri çekme işlemi sonrasında
        ...
        ResultSet rs = st.executeQuery(sql1); //default olarak forward only dir
        while (rs.next()) {
        ...
        st.executeQuery("SELECT phone_code,country_name FROM countries WHERE phone_code>200");
        ...
        while (rs3.next()) {
            System.out.println("id: " + rs3.getInt("id") + "----isim: " + rs3.getString("name")
        ...
        while (rs4.next()) {
            System.out.println("isim : " + rs4.getString("isim") + " --- puan : " + rs4.getString("puan"));
        }
*/
